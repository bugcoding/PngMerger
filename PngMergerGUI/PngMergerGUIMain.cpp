...
const long PngMergerGUIFrame::ID_SPINCTRL4 = wxNewId();
const long PngMergerGUIFrame::ID_SPINCTRL1 = wxNewId();
...
PngMergerGUIFrame::PngMergerGUIFrame(wxWindow* parent,wxWindowID id)
{
    ...
    imgeFmtChoice = new wxChoice(leftPanel, ID_CHOICE2, wxPoint(130,136), wxSize(144,22), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE2"));
    imgeFmtChoice->Append(_("RGBA"));
    imgeFmtChoice->Append(_("RGBA8888"));
    imgeFmtChoice->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BACKGROUND));
    ...
    maxWidCtrl = new wxSpinCtrl(leftPanel, ID_SPINCTRL4, _T("0"), wxPoint(144,288), wxSize(129,22), 0, 0, 100, 0, _T("ID_SPINCTRL4"));
    maxWidCtrl->SetValue(_T("0"));
    maxWidCtrl->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BACKGROUND));
    MaxHgtCtrl = new wxSpinCtrl(leftPanel, ID_SPINCTRL1, _T("0"), wxPoint(144,320), wxSize(129,22), 0, 0, 100, 0, _T("ID_SPINCTRL1"));
    MaxHgtCtrl->SetValue(_T("0"));
    MaxHgtCtrl->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BACKGROUND));
